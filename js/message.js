...
function pintarRespuestaMensajes(respuesta){
    ...
    "<thead><tr><th>ID</th><th>MENSAJE</th><th>Cubiculos</th><th>CLIENTE</th><th colspan='3'></th></tr></thead>";
    for(i=0;i<respuesta.length;i++){
        let messageText = respuesta[i].messageText? respuesta[i].messageText : null;
        let CubiculosName = respuesta[i].Cubiculos? respuesta[i].Cubiculos.name : null;
